...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary">
                    <div class="collapse navbar-collapse show">
                        <div class="navbar-nav ms-auto py-0">
                            <a href="/Duan1/mvc-oop-basic/index.php?act=giaodien" class="nav-item nav-link">Trang chủ</a>
    ...
    <div class="container-fluid page-header py-5">
        ...
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInUp" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="/Duan1/mvc-oop-basic/index.php?act=giaodien">Trang chủ</a></li>
                        ...
                        <form method="POST" action="/Duan1/mvc-oop-basic/index.php?act=loginUser">
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="col-12 text-center">
                                    <p class="mb-0">
                                        Chưa có tài khoản?
                                        <a href="/Duan1/mvc-oop-basic/index.php?act=registerUser" class="text-primary">Đăng ký ngay</a>
                                    </p>
                                </div>
                            </div>
                        </form>
