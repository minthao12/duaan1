                    ...
                    <form method="GET" action="/Duan1/mvc-oop-basic/index.php">
                        ...
                        <div class="d-flex border rounded-pill">
                            ...
                            <select class="form-select text-dark border-0 border-start rounded-0 p-3" style="width: 200px;">
                                ...
                                <option value="Pest Control-2">Áo nam</option>
                                <option value="Pest Control-3">Áo nữ</option>
            ...
            <div class="col-md-4 col-lg-3 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a href="#" class="text-muted d-flex align-items-center justify-content-center"><span
                        ...
                        <span class="text-dark ms-2">0.vnd</span></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <div class="nav-item dropdown d-block d-lg-none mb-3">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Trang chủ </a>
                                <div class="dropdown-menu m-0">
                                    <ul class="list-unstyled categories-bars">
                                        <li>
                                            <div class="categories-bars-item">
                    ...
                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                        <div class="product-item-inner border rounded">
                            <div class="product-item-inner-item">
                                <img
                                    src="/Duan1/mvc-oop-basic/uploads/<?= htmlspecialchars($item['image']) ?>"
                                ...
                                <div class="product-details">
                                    <a href="/Duan1/mvc-oop-basic/index.php?act=detail&id=<?= $item['product_id'] ?>">
                            ...
                            <div class="text-center rounded-bottom p-4">
                                ...
                                <a href="/Duan1/mvc-oop-basic/index.php?act=detail&id=<?= $item['product_id'] ?>" class="d-block h4">
                                    <?= htmlspecialchars($item['product_name']) ?>
                                </a>

                                <span class="text-primary fs-5 d-block mb-2">
                                    <?= number_format($item['price']) ?>đ
                                </span>

                                <span class="text-muted fs-6 d-block mb-3">
                                    <?php if ((int)$item['stock'] > 0): ?>
                                        Còn hàng: <?= (int)$item['stock'] ?>
                                    <?php else: ?>
                                        Hết hàng
                                    <?php endif; ?>
                                </span>
            ...
            <div class="row g-4 rounded mb-5" style="background: rgba(255, 255, 255, .03);">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="rounded p-4">
                        ...
                        <div>
                            <h4 class="text-white">HDTTstors.com.vn</h4>
                            <p class="mb-2">0967807956</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-md-6 text-center text-md-start mb-md-0">
                    <span class="text-white"><a href="#" class="border-bottom text-white"><i
                                class="fas fa-copyright text-light me-2"></i>HDTT store</a>, .</span>
                </div>
